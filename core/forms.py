...
class ResidentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'gp_name': forms.TextInput(attrs={'class': 'form-control', 'list': 'gpNameSuggestions', 'autocomplete': 'off'}),
            'gp_surgery': forms.TextInput(attrs={'class': 'form-control', 'list': 'gpSurgerySuggestions', 'autocomplete': 'off'}),
            'gp_contact': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Phone number'}),
            'pharmacy_name': forms.TextInput(attrs={'class': 'form-control', 'list': 'pharmacyNameSuggestions', 'autocomplete': 'off'}),
